...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'askbot_thread', 'added_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Thread.added_at'
        db.alter_column(u'askbot_thread', 'added_at', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'image_url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'interesting_tags': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_fake': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_lawexpert': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
